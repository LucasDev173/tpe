            ...
            <div class="col-4">
                ...
                <div class="mt-3 row">
                    <form action="modif" method="POST">
                        <input type="text" name="titulo" placeholder="{$libro->titulo}">
                        <input type="text" name="autor" placeholder="{$libro->autor}">
                        <input type="text" name="precio" placeholder="{$libro->precio}">
                        <input type="text" name="categoria" placeholder="{$libro->nombre}">
